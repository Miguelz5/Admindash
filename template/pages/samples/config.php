            ...
            <div class="card-body2">
                <div class="profile-pic2">
                    <div class="count-indicator">
                      <img class="img-xs rounded-circle " src="/template/assets/images/faces/blank.png" alt="">
                      <span class="count bg-success"></span>
                    </div>
                    <div class="profile-name2">
                      <h5 class="mb-0 font-weight-normal">Daniel</h5>
                      <span> ID: 123456 </span>
                    </div>
                  </div>
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                              <div class="card">
                                <div class="card-body">
                                  ...
                                  <canvas id="barChart" style="height:60px"></canvas>
